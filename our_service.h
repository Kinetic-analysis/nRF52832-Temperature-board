...
#define BLE_UUID_OUR_BASE_UUID              {{0x3C, 0x1E, 0x04, 0xD7, 0xE2, 0xAA, 0x42, 0x9B, 0xB5, 0x8D, 0x4D, 0x74, 0x55, 0x14, 0x67, 0xB0}} // 128-bit base UUID
 ...
 */
void our_resistance_characteristic_update(ble_os_t *p_our_service, int32_t *resistance_value);
